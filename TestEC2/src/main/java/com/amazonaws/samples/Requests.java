...
public class Requests {
    ...
    private void init() throws Exception {
        ...
        try {
            ...
            throw new AmazonClientException(
                    ...
                    "location (/Users/nitin/.aws/credentials), and is in valid format.",
                    e);
        }
    ...
    /**
     * Self written code to launch a Node JS EC2 Instance
     */
    public void submitEC2Request() {
...
//			                   .withKeyName("my-key-pair")
     ...
     */
    public void submitSpotRequests() {
        //==========================================================================//
        ...
        // Request 1 x t1.micro instance with a bid price of $0.02.
        ...
        launchSpecification.setImageId("ami-0ff8a91507f77f867");
